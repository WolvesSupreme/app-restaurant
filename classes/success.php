...
class Success
{
    ...
    const SUCCESS_ADMIN_NEWEMPLOYESS     = "f52228665c4f14c8695b194f670b0ef1";
    const SUCCESS_EXPENSES_DELETE       = "fcd919285d5759328b143801573ec47d";
    const SUCCESS_CATEGORY_DELETE       = "fcd919285d5759328b143801573ec47d";
    ...
    public function __construct()
    {
        $this->successList = [
            ...
            Success::SUCCESS_ADMIN_NEWEMPLOYESS => "Nuevo empleado creada correctamente",
            Success::SUCCESS_EXPENSES_DELETE => "Gasto eliminado correctamente",
            Success::SUCCESS_CATEGORY_DELETE => "Categoría eliminada correctamente",
